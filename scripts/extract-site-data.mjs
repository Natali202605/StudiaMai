...
const content = {
  ...
  master_role: 'Специалист с медицинским образованием, броволог, Brow-мастер, ламинирование ресниц, депиляция',
  ...
  footer_vk: 'ВКонтакте: brow_studia_may',
  footer_vk_url: 'https://vk.ru/brow_studia_may',
